...
public class Chrono extends JFrame{
	...
	private int Lap = 1;													//permet de savoir combien de fois le button lap a ete actionn�
	...
	private void initComposant() {
		...
		//parcourir le tableau initialis� afin de cr�er nos boutons avec le texte, dimension et on les ajoute au sous conteneur
	...
	//Listener affect� au boutton Start
	...
	//Listener affect� au button Lap
	class LapListener implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			if(Lap == 3) {
				tab_button[1].setEnabled(false);			//si les 3 laps ont deja ete utilis�s, le button lap est desactiv�
			}
	...
	//Listener affect� au button Stop
	...
	//Listener affect� au button Resume
	...
	//Listener affect� au button Reset
